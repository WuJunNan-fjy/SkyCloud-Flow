...
import com.wjn.common.utils.file.FileUploadUtils;
import com.wjn.common.utils.file.MimeTypeUtils;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception
    {
        ...
        {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(SkyConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
