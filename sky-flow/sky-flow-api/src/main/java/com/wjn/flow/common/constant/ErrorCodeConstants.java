package com.wjn.flow.common.constant;


import com.wjn.common.exception.ErrorCode;
...
public interface ErrorCodeConstants {
    ...
    ErrorCode MODEL_DEPLOY_FAIL_TASK_CANDIDATE_NOT_CONFIG = new ErrorCode(1_009_002_004, "部署流程失败，" + "原因：用户任务({})未配置审批人，请点击【流程设计】按钮，选择该它的【任务（审批人）】进行配置");
