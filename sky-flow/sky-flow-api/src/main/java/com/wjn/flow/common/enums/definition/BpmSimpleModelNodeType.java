...
public enum BpmSimpleModelNodeType implements IntArrayValuable {
    ...
    CONDITION_BRANCH_NODE(51, " “parallelGateway”", "条件分支节点"), // TODO @wjn：是不是改成叫 条件分支？
    PARALLEL_BRANCH_NODE(52, "exclusiveGateway", "并行分支节点"), // TODO @wjn：是不是一个 并行分支 ？就可以啦？ 后面是否去掉并行网关。只用包容网关
    INCLUSIVE_BRANCH_NODE(53, "inclusiveGateway", "包容分支节点"),
    // TODO @wjn：建议整合 join，最终只有 条件分支、并行分支、包容分支，三种~
    // TODO @wjn。 感觉还是分开好理解一点,也好处理一点。前端结构中把聚合节点显示并传过来。
    ;
