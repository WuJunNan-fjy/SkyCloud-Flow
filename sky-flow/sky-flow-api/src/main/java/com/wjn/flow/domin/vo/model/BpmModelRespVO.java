...
import com.wjn.flow.domin.vo.process.BpmProcessDefinitionRespVO;
import com.wjn.flow.domin.vo.user.UserSimpleBaseVO;
...
public class BpmModelRespVO extends BpmModelMetaInfoVO {
    ...
    @Schema(description = "流程标识", requiredMode = Schema.RequiredMode.REQUIRED, example = "process_wjn")
    private String key;

    @Schema(description = "流程名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "天云")
    private String name;
