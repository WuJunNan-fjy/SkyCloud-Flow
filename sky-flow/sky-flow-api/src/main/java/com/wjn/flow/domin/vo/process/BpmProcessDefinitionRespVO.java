package com.wjn.flow.domin.vo.process;
...
public class BpmProcessDefinitionRespVO {
    ...
    @Schema(description = "流程名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "wjn")
    private String name;

    @Schema(description = "流程标识", requiredMode = Schema.RequiredMode.REQUIRED, example = "wjn")
    private String key;

    @Schema(description = "流程图标", requiredMode = Schema.RequiredMode.REQUIRED, example = "")
    private String icon;
