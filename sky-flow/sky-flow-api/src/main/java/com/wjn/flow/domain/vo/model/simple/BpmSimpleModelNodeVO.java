package com.wjn.flow.domain.vo.model.simple;

import com.fasterxml.jackson.annotation.JsonIgnore;
import com.fasterxml.jackson.annotation.JsonInclude;
import com.wjn.common.validation.InEnum;
import com.wjn.flow.common.enums.candidate.BpmTaskCandidateStrategyEnum;
import com.wjn.flow.common.enums.definition.*;
...
public class BpmSimpleModelNodeVO {
    ...
    // TODO @wjn：和 gpt 大模型对了下这个字段的命名，貌似叫 displayText 合适点。可以等最后我们全局替换下。（优先级：低）
    @Schema(description = "节点展示内容", example = "指定成员: 系统管理员")
    ...
    // TODO @wjn：看看是不是可以简化；@wjn： 暂时先放着。不知道后面是否会用到
    /**
    ...
    public static class OperationButtonSetting {
        ...
        // TODO @wjn：是不是按钮的标识？id 会和数据库的 id 自增有点模糊，key 标识会更合理一点点哈。
    ...
    // TODO @wjn：条件；建议可以固化的一些选项；然后有个表达式兜底；要支持
}
